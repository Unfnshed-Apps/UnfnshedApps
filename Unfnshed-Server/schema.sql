...
-- When override_enabled is true and a job's demand matches the nest's contents,
-- the nester uses the pre-built layout verbatim instead of computing its own.
